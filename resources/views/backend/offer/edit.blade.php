                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.offers')}}">Offer</a>
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">   
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            {{ Form::model($offer,['route' => ['admin.offers.update'], 'method' => 'post', 'id' => 'form']) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('name', old('name'), ['class' => 'form-control','pattern'=> "^[a-zA-Z_ ]*$", 'placeholder' => 'Enter offer Name', 'id' => 'offers_name']) }}
                                            @error('name')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="emailsubject">Offer Code<span
                                                    style="color: red;font-size:18px;"><b>*</b></span></label>
                                            {{ Form::text('offer_code', old('offer_code'), ['class' => 'form-control', 'placeholder' => 'Enter Code', 'id' => 'offer_code']) }}
                                            @error('offer_code')
                                                <p style="color:red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                            ...
                                            <label for="emailname">Offer Type<span
                                             ...
                                             <select name="offer_type" class="form-control">
                                               <option  value=''>Select Type</option>                                              
                                                <option @if($offer->offer_type=='Fixed') selected @else @endif value="Fixed">Fixed</option>    
                                                <option @if($offer->offer_type=='Not Fixed') selected @else @endif value="Not Fixed">Not Fixed</option>                                            
                                           </select>
                                            @error('offer_type')
                                                <p style="color:red;">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="destination_id" class="form-control">
                                               ...
                                               @foreach($destinations as $destination)
                                                <option @if($destination->id == $offer->destination_id) selected @else @endif value="{{$destination->id}}">{{$destination->name}}</option>
                                               @endforeach
                                           </select>
                                            ...
                                            <label for="emailsubject">Itinerary<span
                                             ...
                                             <select name="itinerary" class="form-control">
                                               <option value=''>Select itinerary</option>                                              
                                                <option  @if($offer->itinerary=='Hotel') selected @else @endif value="Hotel">Hotel</option>
                                                <option @if($offer->itinerary=='Flight') selected @else @endif value="Flight">Flight</option>
                                                <option @if($offer->itinerary=='GuestHouse') selected @else @endif value="GuestHouse">GuestHouse</option>                                           
                                           </select>
                                            @error('itinerary')
                                                <p style="color:red;">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <input type="hidden" name="id" value="@if(isset($offer->id)){{$offer->id}} @else @endif"/>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="emailsubject">Travel Date To<span
                                                    style="color: red;font-size:18px;"><b>*</b></span></label>
                                                {{ Form::date('travel_date_to', old('travel_date_to'), ['class' => 'form-control', 'placeholder' => 'Enter Booking Date To', 'id' => 'my_date_picker']) }}
                                    ...
                                    <div class="custom-control custom-checkbox mr-sm-2 m-b-15">
                                        <input type="checkbox" class="custom-control-input" name="status" id="checkbox0"  value="1" @if($offer->status==1) checked @else @endif>
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.offers') }}" class="btn btn-secondary">Back</a>
                            </div>
                            {{ Form::close() }}
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.validator.addMethod("endtavelDate", function(value, element) {
                const starttravelDate = $('.starttavelDate').val();
