...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Commission Create</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            {{ Form::open(['route' => ['admin.commission.save'], 'method' => 'post', 'id' => 'form']) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('name', old('name'), ['class' => 'form-control', 'pattern'=> "^[a-zA-Z_ ]*$", 'placeholder' => 'Enter Commission Name', 'id' => 'destination_name']) }}
                                            @error('name')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="emailsubject">Travel Date To<span
                                                    style="color: red;font-size:18px;"><b>*</b></span></label>
                                                {{ Form::date('travel_date_to', old('travel_date_to'), ['class' => 'endtavelDate form-control', 'placeholder' => 'Enter Travel Date To', 'id' => 'my_date_picker']) }}
