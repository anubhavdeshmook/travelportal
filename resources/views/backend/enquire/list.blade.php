...
<div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-inline">
                            {{ Form::open(['route' => ['admin.enquries.filter'], 'method' => 'get', 'id' => 'form']) }}                
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('admin.enquries') }}" title="reload" class="btn btn-Secondary"><i
                        ...
                        <table id="table" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                @foreach ($enquries as $key => $enqurie)
                                        ...
                                        <td>{{ $enqurie->name }}</td>
                                        <td>{{ $enqurie->description }}</td>
                                        <td>{{ $enqurie->created_at->format(config('app.time')) }}</td>
                                        <td>{{ $enqurie->updated_at->format(config('app.time')) }}</td>
                                        <td onclick="myFunction({{ $enqurie->id }}); ">@if ($enqurie->status == 1)<button class="btn btn-success"> <span >Active </span> </button> </a>@else  <button class="btn btn-danger"> <span >Inactive </span> </button> @endif
                                        </td>
                                        <td> <a href="{{ route('admin.enquries.view', $enqurie->id) }}"><button
                                                    class="btn btn-warning" title="view"><i class="fas fa-eye"></i> 
                                                </button></a>
                                         
                                                 <button class="btn btn-danger" title="delete"
                                                onclick="confirmDeleteModal(@php echo $enqurie->id; @endphp)"><i
   ...
   <script type="text/javascript">
        ...
        function deleteData(id) {
            location.replace("{{ route('admin.enquries.delete') }}?id=" + id);
        }
    </script>
    {{-- end --}}
    ...
    <script>
        ...
        function changedataData(id) {
            location.replace("{{ route('admin.enquries.changestatus') }}?id=" + id);
        }
    </script>
    {{-- end --}}
