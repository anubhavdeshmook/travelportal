                ...
                <div class="row">
                    ...
                    <div class="col-md-12">   
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            {{ Form::model($email, ['route' => ['admin.email.update', $email->id], 'method' => 'post', 'id' => 'form']) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="custom-control custom-checkbox mr-sm-2 m-b-15">
                                        <input type="checkbox" class="custom-control-input" name="status" id="checkbox0"  value="1" @if($email->status ==1) checked @else @endif>
