                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            {{ Form::open(['route' => ['admin.testimonials.save'], 'method' => 'post', 'id' => 'form']) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="testimonialname">User Name<span
                                                    style="color: red;font-size:18px;"><b>*</b></span></label>
                                            {{ Form::text('name', old('name'), ['class' => 'form-control','pattern'=> "^[a-zA-Z_ ]*$", 'placeholder' => 'Enter User Name', 'id' => 'emailname']) }}
                                            @error('name')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                {{ Form::textarea('description', old('description'), ['class' => 'form-control', 'placeholder' => 'Enter Description', 'id' => 'email_contentss']) }}
                                                @error('description')
                                                    <p style="color:red;">{{ $message }}</p>
                                                @enderror
                                            </div>
